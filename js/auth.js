...
const INITIAL_USERS = [
  ...
  { id: 'USR-1002', name: 'أحمد موظف المبيعات', email: 'emp@store.com', role: 'employee', createdAt: '2026-07-05T12:00:00Z' },
  { id: 'USR-1003', name: 'محمود أمين المخزن', email: 'store@store.com', role: 'storekeeper', createdAt: '2026-07-10T09:00:00Z' }
];
...
window.login = function(email, password) {
  ...
  if (!user && cleanEmail !== 'admin@store.com' && cleanEmail !== 'emp@store.com') {
