 ...
 * Connected to Firebase Auth & Active Session Storage
 */
...
window.getCurrentUser = function() {
  // Check Firebase Auth current user if active
  ...
  // Check active session in sessionStorage (clears automatically when browser/tab closes)
  ...
  // Strictly return null when unauthenticated - FORCE LOGIN SCREEN
  return null;
};
